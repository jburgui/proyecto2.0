...
/**
 * Formulario Distración 
 * @author Javier Burguillo Sánchez
 */

class DistraccionType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'proyecto\backendBundle\Entity\Distraccion'
        ));
    }
    ...
    {
        return 'proyecto_backendbundle_distracciontype';
    }
}
